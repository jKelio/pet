    ...
    en: {
        pet: {
            ...
            "results": {
                ...
                "exporting": "Exporting...",
                "exportProgress": "Exporting section {{current}} of {{total}}...",
                "exportComplete": "Export complete!",
                "exportFailed": "Export failed",
                "exportFailedSection": "Failed to export section: {{section}}",
                "exportContinuing": "Continuing with remaining sections...",
                "preparingExport": "Preparing export...",
                "finalizingExport": "Finalizing PDF...",
    ...
    de: {
        pet: {
            ...
            "results": {
                ...
                "exportProgress": "Exportiere Abschnitt {{current}} von {{total}}...",
                "exportComplete": "Export abgeschlossen!",
                "exportFailed": "Export fehlgeschlagen",
                "exportFailedSection": "Abschnitt konnte nicht exportiert werden: {{section}}",
                "exportContinuing": "Fahre mit den übrigen Abschnitten fort...",
                "preparingExport": "Export wird vorbereitet...",
                "finalizingExport": "PDF wird fertiggestellt...",
    ...
    ru: {
        pet: {
            ...
            results: {
                ...
                exporting: "Экспорт...",
                exportProgress: "Экспорт раздела {{current}} из {{total}}...",
                exportComplete: "Экспорт завершён!",
                exportFailed: "Ошибка экспорта",
                exportFailedSection: "Не удалось экспортировать раздел: {{section}}",
                exportContinuing: "Продолжаем с оставшимися разделами...",
                preparingExport: "Подготовка экспорта...",
                finalizingExport: "Завершение PDF...",
